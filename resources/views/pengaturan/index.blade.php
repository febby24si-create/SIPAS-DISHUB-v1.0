<x-app-layout>
    ...
    <div style="display:flex; align-items:flex-start; gap:12px; padding:16px 20px; background:#fffbeb; border:1px solid #fde68a; border-radius:14px; color:#92400e; font-size:13px; line-height:1.6;">
        ...
        <span>Halaman pengaturan sistem (identitas instansi, backup, preferensi umum, dsb.) belum dikembangkan pada tahap ini karena kebutuhannya belum dikonfirmasi. Menu ini disediakan agar navigasi sidebar lengkap dan tidak menghasilkan route error.</span>
    </div>
</x-app-layout>
